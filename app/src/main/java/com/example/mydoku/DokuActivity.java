...
import com.example.mydoku.database.DataHelper;
import com.example.mydoku.report.ReportActivity;
import com.jaredrummler.materialspinner.MaterialSpinner;



public class DokuActivity extends AppCompatActivity
    ...
    private class MyAdapterRevenue extends ArrayAdapter {
        ...
        //konstruktor
        public MyAdapterRevenue(DokuActivity dokuActivity, String[] list_deskripsi, String list_kategori[], String list_jumlah[], String list_tanggal[]) {
            super(dokuActivity, R.layout.item_pendapatan, list_deskripsi);
            activity = dokuActivity;
    ...
    private class MyAdapterExpense extends ArrayAdapter {
        ...
        //konstruktor
        public MyAdapterExpense(DokuActivity dokuActivity, String[] list_deskripsi, String list_kategori[], String list_jumlah[], String list_tanggal[]) {
            super(dokuActivity, R.layout.item_pengeluaran, list_deskripsi);
            activity = dokuActivity;
            this.list_deskripsi = list_deskripsi;
            this.list_kategori  = list_kategori;
            this.list_jumlah    = list_jumlah;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            getApplicationContext().deleteDatabase("mydoku.db");
            finish();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(DokuActivity.this, MainActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_doku) {
            Toast.makeText(this, "MyDoku", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_kategori_pendapatan) {
            Intent intent = new Intent(DokuActivity.this, KategoriPendapatan.class);
            startActivity(intent);
        } else if (id == R.id.nav_kategori_pengeluaran) {
            Intent intent = new Intent(DokuActivity.this, KategoriPengeluaran.class);
            startActivity(intent);
        } else if (id == R.id.nav_monthly) {
            Intent intent = new Intent(DokuActivity.this, ReportActivity.class);
            startActivity(intent);
