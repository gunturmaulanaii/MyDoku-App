package com.example.mydoku.report;
...
import com.example.mydoku.DokuActivity;
import com.example.mydoku.KategoriPendapatan;
import com.example.mydoku.KategoriPengeluaran;
import com.example.mydoku.MainActivity;
import com.example.mydoku.R;
...
public class ReportActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(ReportActivity.this, DokuActivity.class);
            startActivity(intent);
